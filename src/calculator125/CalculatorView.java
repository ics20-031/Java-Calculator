...
public class CalculatorView extends JFrame {
	...
	// Sets up the view and adds the visual Java Swing components.
        ...
        // Add the calcMultiplyPanel versions of the components to the
        // JPanel named calcMultiplyPanel.
        ...
        // Add the calcMultiplyPanel JPanel to the JFrame
	...
	void displayErrorMessage(String errorMessage) {
        ...
        public void setProductValue(int productSolution) {
		
		productValue.setText(Integer.toString(productSolution));		
	}
        
        void addProductListener(ActionListener listenForProductButton) {
		
		calculateProduct.addActionListener(listenForProductButton);		
	}
